...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		//Metodo para Criar os Clientes e Enderecos na tabela do banco H2
		...
		//Instanciacao dos objetos Pedido e Pagamento
		...
		// Salvar os Pagamentos e Estados no BD
		pedidoRepository.saveAll(Arrays.asList(ped1, ped2));
		pagamentoRepository.saveAll(Arrays.asList(pagt1, pagt2));
		
				
		//Instanciacao dos objetos de itemPedido
